...
public class cfg {
private final MMOExpansion PLUGIN;
private final String FILENAME;
private final File FOLDER;
private FileConfiguration config;
private File configFile;
 
public cfg(String filename, MMOExpansion instance) {
...
public cfg(File folder, String filename, MMOExpansion instance) {
if(!filename.endsWith(".yml")) {
filename += ".yml";
}
this.FILENAME = filename;
...
//this.PLUGIN.getLogger().log(Level.WARN, "Unable to create folder " + this.FOLDER.getName() + ".");
}
} catch(Exception e) {
...
//this.PLUGIN.getLogger().log(Level.WARN, "Could not save config to " + configFile.getName(), ex);
}
}
